...
If you already have Java 25 or higher installed, you can use the JAR file for your platform and execute it with `java -jar` command.
...
You need to have Java 25 or higher installed, along with maven.
