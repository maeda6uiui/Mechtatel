...
class ReleaseBundler:
    def __init__(
        ...
        self.__package_dir=self.__working_dir.joinpath(package_root_dirname).joinpath(package_dirname)
    ...
    def __create_release_archive(self)->Path:
        ...
        archive_file=archive_file.rename(self.__working_dir.joinpath(archive_file.name))
