...
interface IMechtatelForMttWindow {
     ...
     * Use {@link #recreate(MttWindow, int, int)} if you want to run some procedure
     ...
     * Use {@link #reshape(MttWindow, int, int)} if you want to be notified of window resize in realtime.
     *
     * @param window Window
     * @param width  New width
     * @param height New height
