...
public class Vertex3DUV {
    ...
    public Vertex3DUV(Vector3fc pos, Vector4fc color, Vector2fc texCoords, Vector3fc normal) {
        this.pos = pos;
        this.color = color;
    ...
    public Vertex3DUV(Vector3fc pos, Vector4fc color, Vector2fc texCoords) {
        this.pos = pos;
        this.color = color;
        this.texCoords = texCoords;
