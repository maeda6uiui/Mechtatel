 ...
 * @author maeda
 */
class CopyDepthNabor extends Nabor {
    private int shadowDepthImageFormat;

    public CopyDepthNabor(VkDevice device, int shadowDepthImageFormat) {
    ...
    protected void createRenderPass(int colorImageFormat) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            colorAttachment.format(shadowDepthImageFormat);
    ...
    protected void createDescriptorSetLayouts() {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkDescriptorSetLayoutBinding depthImageLayoutBinding = imageBindings.get(0);
            ...
            VkDescriptorSetLayoutCreateInfo.Buffer layoutInfos = VkDescriptorSetLayoutCreateInfo.callocStack(2, stack);
    ...
    protected void createDescriptorPools(int descriptorCount) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkDescriptorPoolCreateInfo.Buffer poolInfos = VkDescriptorPoolCreateInfo.callocStack(2, stack);
    ...
    protected void createImages(int colorImageFormat) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            ImageUtils.createImage(
                    ...
                    pImage,
                    pImageMemory);
            long shadowDepthImage = pImage.get(0);
            long shadowDepthImageMemory = pImageMemory.get(0);
            ...
            long shadowDepthImageView = pImageView.get(0);

            this.getImages().add(shadowDepthImage);
            this.getImageMemories().add(shadowDepthImageMemory);
            this.getImageViews().add(shadowDepthImageView);
        }
    }
}
