 ...
 * @author maeda
 */
class CopyDepthNabor extends PostProcessingNabor {
    public CopyDepthNabor(VkDevice device) {
    ...
    protected void createDescriptorSetLayouts() {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            depthImageLayoutBinding.binding(0);
    ...
    protected void createDescriptorPools(int descriptorCount) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkDescriptorPoolSize depthImagePoolSize = imagePoolSizes.get(0);
    ...
    protected void createDescriptorSets(int descriptorCount, long commandPool, VkQueue graphicsQueue) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            uboDescriptorWrite.pBufferInfo(null);

            //=== set 1 ===
            VkDescriptorImageInfo.Buffer imageInfos = VkDescriptorImageInfo.callocStack(1, stack);
            VkDescriptorImageInfo imageInfo = imageInfos.get(0);
    ...
    protected void createGraphicsPipelines() {
        ...
        if (this.getVertShaderModules().size() != 0) {
            ...
            final String vertShaderFilepath = "./Mechtatel/Shader/Standard/PostProcessing/ShadowMapping/copy_depth.vert";
            final String fragShaderFilepath = "./Mechtatel/Shader/Standard/PostProcessing/ShadowMapping/copy_depth.frag";
