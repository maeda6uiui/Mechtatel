...
import com.github.maeda6uiui.mechtatel.core.physics.PhysicalBox3D;
...
public class PhysicalObjectSample extends Mechtatel {
    ...
    private List<PhysicalBox3D> physicalCubes;
    ...
    public void update() {
        ...
        if (this.getKeyboardPressingCount("ENTER") == 1) {
            ...
            physicalCubes.add(physicalCube);
        }
        if (this.getKeyboardPressingCount("C") == 1) {
            physicalCubes.forEach(p -> p.cleanup());
            physicalCubes.clear();
        }
    }
